...
export const Features = () => {
  return <section className="py-20 md:py-24">
    <div className="container">
      ...
      <p className="text-wwhite/70 text-lg md:text-xl max-w-2xl mx-auto tracking-tight text-center mt-5">From small startups to large enterprises, our AI-driven tool has
